...
jupyter nbconvert --execute --to notebook --output "feature_analysis_run" --output-dir "/opt/users/gpel0001/cce3503/assignment-1" "/opt/users/gpel0001/cce3503/assignment-1/feature_analysis_plots.ipynb"